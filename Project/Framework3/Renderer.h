...
public:
	...
	ShaderID addShader(const char *fileName, const char *extra, const StreamDesc *streamOut, const uint nElements, const uint flags);
	ShaderID addShader(const char *fileName, const char **attributeNames, const int nAttributes, const char *extra = NULL, const StreamDesc *streamOut = NULL, const uint nElements = 0, const uint flags = 0);
	virtual ShaderID addShader(const char *vsText, const char *gsText, const char *fsText, const int vsLine, const int gsLine, const int fsLine,
		const char *header = NULL, const char *extra = NULL, const StreamDesc *streamOut = NULL, const uint nElements = 0, const char *fileName = NULL, const char **attributeNames = NULL, const int nAttributes = 0, const uint flags = 0) = 0;
	...
	virtual VertexBufferID addVertexBuffer(const long size, const BufferAccess bufferAccess, const void *data = NULL, const uint flags = 0) = 0;
	...
	virtual int getVertexFormatSize(const VertexFormatID vertexFormat) = 0;
...
/*	void setSamplerState(const uint samplerUnit, const SamplerStateID samplerState){
	...
	virtual void changeVertexBuffers(const int streams, const int numStreams, const VertexBufferID *vertexBufferIDs, const intptr *offsets = NULL) = 0;
	virtual void changeStreamTargets(const int numStreams, const VertexBufferID *vertexBufferIDs, const intptr *offsets = NULL) = 0;
