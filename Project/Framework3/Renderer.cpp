...
ShaderID Renderer::addShader(const char *fileName, const uint flags){
	return addShader(fileName, NULL, 0, NULL, (StreamDesc*)NULL, 0, flags);
}

ShaderID Renderer::addShader(const char *fileName, const char *extra, const uint flags){
	return addShader(fileName, NULL, 0, extra, NULL, 0, flags);
}

ShaderID Renderer::addShader(const char *fileName, const char *extra, const StreamDesc *streamOut, const uint nElements, const uint flags){
	return addShader(fileName, NULL, 0, extra, streamOut, nElements, flags);
}
